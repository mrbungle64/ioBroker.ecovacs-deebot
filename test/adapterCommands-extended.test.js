...
describe('adapterCommands.js extended', () => {
    ...
    describe('handleStateChange extended branches', () => {
        it('should handle map.lastUsedCustomAreaValues_save', async () => {
            ...
            await adapterCommands.handleStateChange(adapter, ctx, 'ecovacs-deebot.0.map.lastUsedCustomAreaValues_save', { ack: false, val: true });
        ...
        it('should handle map.currentSpotAreaValues_save', async () => {
            ...
            mockAdapterHelper.getChannelNameById.returns('map');
            mockAdapterHelper.getSubChannelNameById.returns('');
            await adapterCommands.handleStateChange(adapter, ctx, 'ecovacs-deebot.0.map.currentSpotAreaValues_save', { ack: false, val: true });
        ...
        it('should handle control.spotArea with 950 type and 2 cleanings', async () => {
            ...
            await adapterCommands.handleStateChange(adapter, ctx, 'ecovacs-deebot.0.control.spotArea', { ack: false, val: '1,2' });
        ...
        it('should handle control.customArea with cleanings', async () => {
            ...
            await adapterCommands.handleStateChange(adapter, ctx, 'ecovacs-deebot.0.control.customArea', { ack: false, val: '100,200,300,400,2' });
            expect(ctx.vacbot.run.called).to.be.true;
        });
        ...
        it('should handle control.customArea with basic area values', async () => {
            ...
            await adapterCommands.handleStateChange(adapter, ctx, 'ecovacs-deebot.0.control.customArea', { ack: false, val: '100,200,300,400' });
            expect(ctx.vacbot.run.called).to.be.true;
        });
        ...
        it('should handle control.cleanSpeed', async () => {
            ...
            mockAdapterHelper.getSubChannelNameById.returns('');
            ctx.getModel().isModelTypeAirbot.returns(false);
            await adapterCommands.handleStateChange(adapter, ctx, 'ecovacs-deebot.0.control.cleanSpeed', { ack: false, val: 2 });
        ...
        it('should handle control.waterLevel', async () => {
            ...
            mockAdapterHelper.getChannelNameById.returns('control');
            mockAdapterHelper.getSubChannelNameById.returns('');
            await adapterCommands.handleStateChange(adapter, ctx, 'ecovacs-deebot.0.control.waterLevel', { ack: false, val: 2 });
        ...
        it('should handle control.reconnect', async () => {
            ...
            mockAdapterHelper.getChannelNameById.returns('control');
            mockAdapterHelper.getSubChannelNameById.returns('');
            await adapterCommands.handleStateChange(adapter, ctx, 'ecovacs-deebot.0.control.reconnect', { ack: false, val: true });
        ...
        it('should handle move commands', async () => {
            ...
            await adapterCommands.handleStateChange(adapter, ctx, 'ecovacs-deebot.0.control.move.forward', { ack: false, val: true });
        ...
        it('should handle consumable main_brush_reset', async () => {
            ...
            mockAdapterHelper.getSubChannelNameById.returns('');
            await adapterCommands.handleStateChange(adapter, ctx, 'ecovacs-deebot.0.consumable.main_brush_reset', { ack: false, val: true });
        ...
        it('should handle consumable filter_reset', async () => {
            ...
            mockAdapterHelper.getChannelNameById.returns('consumable');
            mockAdapterHelper.getSubChannelNameById.returns('');
            await adapterCommands.handleStateChange(adapter, ctx, 'ecovacs-deebot.0.consumable.filter_reset', { ack: false, val: true });
        ...
        it('should handle extended.pauseWhenEnteringSpotArea', async () => {
            ...
            await adapterCommands.handleStateChange(adapter, ctx, 'ecovacs-deebot.0.control.extended.pauseWhenEnteringSpotArea', { ack: false, val: '5' });
        ...
        it('should handle extended.volume', async () => {
            ...
            mockAdapterHelper.getChannelNameById.returns('control');
            mockAdapterHelper.getSubChannelNameById.returns('extended');
            await adapterCommands.handleStateChange(adapter, ctx, 'ecovacs-deebot.0.control.extended.volume', { ack: false, val: 5 });
        ...
        it('should handle extended.advancedMode', async () => {
            ...
            mockAdapterHelper.getChannelNameById.returns('control');
            mockAdapterHelper.getSubChannelNameById.returns('extended');
            await adapterCommands.handleStateChange(adapter, ctx, 'ecovacs-deebot.0.control.extended.advancedMode', { ack: false, val: true });
        ...
        it('should handle extended.autoEmpty', async () => {
            ...
            mockAdapterHelper.getChannelNameById.returns('control');
            mockAdapterHelper.getSubChannelNameById.returns('extended');
            await adapterCommands.handleStateChange(adapter, ctx, 'ecovacs-deebot.0.control.extended.autoEmpty', { ack: false, val: true });
        ...
        it('should handle extended.doNotDisturb', async () => {
            ...
            mockAdapterHelper.getChannelNameById.returns('control');
            mockAdapterHelper.getSubChannelNameById.returns('extended');
            await adapterCommands.handleStateChange(adapter, ctx, 'ecovacs-deebot.0.control.extended.doNotDisturb', { ack: false, val: true });
        ...
        it('should handle extended.continuousCleaning', async () => {
            ...
            mockAdapterHelper.getChannelNameById.returns('control');
            mockAdapterHelper.getSubChannelNameById.returns('extended');
            await adapterCommands.handleStateChange(adapter, ctx, 'ecovacs-deebot.0.control.extended.continuousCleaning', { ack: false, val: true });
        ...
        it('should handle extended.trueDetect', async () => {
            ...
            mockAdapterHelper.getChannelNameById.returns('control');
            mockAdapterHelper.getSubChannelNameById.returns('extended');
            await adapterCommands.handleStateChange(adapter, ctx, 'ecovacs-deebot.0.control.extended.trueDetect', { ack: false, val: true });
        ...
        it('should handle extended.moppingMode', async () => {
            ...
            mockAdapterHelper.getChannelNameById.returns('control');
            mockAdapterHelper.getSubChannelNameById.returns('extended');
            await adapterCommands.handleStateChange(adapter, ctx, 'ecovacs-deebot.0.control.extended.moppingMode', { ack: false, val: 'quick' });
        ...
        it('should handle extended.washInterval', async () => {
            ...
            mockAdapterHelper.getChannelNameById.returns('control');
            mockAdapterHelper.getSubChannelNameById.returns('extended');
            await adapterCommands.handleStateChange(adapter, ctx, 'ecovacs-deebot.0.control.extended.washInterval', { ack: false, val: 10 });
        ...
        it('should handle extended.airDrying', async () => {
            ...
            mockAdapterHelper.getChannelNameById.returns('control');
            mockAdapterHelper.getSubChannelNameById.returns('extended');
            await adapterCommands.handleStateChange(adapter, ctx, 'ecovacs-deebot.0.control.extended.airDrying', { ack: false, val: true });
        ...
        it('should handle extended.selfCleaning', async () => {
            ...
            mockAdapterHelper.getChannelNameById.returns('control');
            mockAdapterHelper.getSubChannelNameById.returns('extended');
            await adapterCommands.handleStateChange(adapter, ctx, 'ecovacs-deebot.0.control.extended.selfCleaning', { ack: false, val: true });
        ...
        it('should handle extended.hostedCleanMode', async () => {
            ...
            mockAdapterHelper.getChannelNameById.returns('control');
            mockAdapterHelper.getSubChannelNameById.returns('extended');
            await adapterCommands.handleStateChange(adapter, ctx, 'ecovacs-deebot.0.control.extended.hostedCleanMode', { ack: false, val: true });
        ...
        it('should handle extended.cleanCount', async () => {
            ...
            mockAdapterHelper.getChannelNameById.returns('control');
            mockAdapterHelper.getSubChannelNameById.returns('extended');
            await adapterCommands.handleStateChange(adapter, ctx, 'ecovacs-deebot.0.control.extended.cleanCount', { ack: false, val: 2 });
        ...
        it('should handle extended.emptyDustBin', async () => {
            ...
            mockAdapterHelper.getChannelNameById.returns('control');
            mockAdapterHelper.getSubChannelNameById.returns('extended');
            await adapterCommands.handleStateChange(adapter, ctx, 'ecovacs-deebot.0.control.extended.emptyDustBin', { ack: false, val: true });
        ...
        it('should handle history.triggerDustboxRemoved', async () => {
            ...
            mockAdapterHelper.getSubChannelNameById.returns('');
            await adapterCommands.handleStateChange(adapter, ctx, 'ecovacs-deebot.0.history.triggerDustboxRemoved', { ack: false, val: true });
        ...
        it('should handle info.currentSchedule_refresh', async () => {
            ...
            mockAdapterHelper.getSubChannelNameById.returns('');
            ctx.getDevice().useV2commands.returns(false);
            await adapterCommands.handleStateChange(adapter, ctx, 'ecovacs-deebot.0.info.currentSchedule_refresh', { ack: false, val: true });
        ...
        it('should handle cleaninglog.requestCleaningLog', async () => {
            ...
            mockAdapterHelper.getSubChannelNameById.returns('');
            await adapterCommands.handleStateChange(adapter, ctx, 'ecovacs-deebot.0.cleaninglog.requestCleaningLog', { ack: false, val: true });
        ...
        it('should handle control.pause when paused', async () => {
            ...
            await adapterCommands.handleStateChange(adapter, ctx, 'ecovacs-deebot.0.control.pause', { ack: false, val: true });
        ...
        it('should handle control.playSoundId', async () => {
            ...
            mockAdapterHelper.getChannelNameById.returns('control');
            mockAdapterHelper.getSubChannelNameById.returns('');
            await adapterCommands.handleStateChange(adapter, ctx, 'ecovacs-deebot.0.control.playSoundId', { ack: false, val: 5 });
        ...
        it('should handle control.playIamHere', async () => {
            ...
            mockAdapterHelper.getChannelNameById.returns('control');
            mockAdapterHelper.getSubChannelNameById.returns('');
            await adapterCommands.handleStateChange(adapter, ctx, 'ecovacs-deebot.0.control.playIamHere', { ack: false, val: true });
        ...
        it('should handle control.spotPurification', async () => {
            ...
            mockAdapterHelper.getChannelNameById.returns('control');
            mockAdapterHelper.getSubChannelNameById.returns('');
            await adapterCommands.handleStateChange(adapter, ctx, 'ecovacs-deebot.0.control.spotPurification', { ack: false, val: 'room1' });
        ...
        it('should handle control.edge', async () => {
            ...
            mockAdapterHelper.getChannelNameById.returns('control');
            mockAdapterHelper.getSubChannelNameById.returns('');
            await adapterCommands.handleStateChange(adapter, ctx, 'ecovacs-deebot.0.control.edge', { ack: false, val: true });
        ...
        it('should handle control.spot', async () => {
            ...
            mockAdapterHelper.getChannelNameById.returns('control');
            mockAdapterHelper.getSubChannelNameById.returns('');
            await adapterCommands.handleStateChange(adapter, ctx, 'ecovacs-deebot.0.control.spot', { ack: false, val: true });
        ...
        it('should handle control.stop', async () => {
            ...
            mockAdapterHelper.getChannelNameById.returns('control');
            mockAdapterHelper.getSubChannelNameById.returns('');
            await adapterCommands.handleStateChange(adapter, ctx, 'ecovacs-deebot.0.control.stop', { ack: false, val: true });
        ...
        it('should handle control.charge', async () => {
            ...
            mockAdapterHelper.getChannelNameById.returns('control');
            mockAdapterHelper.getSubChannelNameById.returns('');
            await adapterCommands.handleStateChange(adapter, ctx, 'ecovacs-deebot.0.control.charge', { ack: false, val: true });
        ...
        it('should handle control.relocate', async () => {
            ...
            mockAdapterHelper.getChannelNameById.returns('control');
            mockAdapterHelper.getSubChannelNameById.returns('');
            await adapterCommands.handleStateChange(adapter, ctx, 'ecovacs-deebot.0.control.relocate', { ack: false, val: true });
        ...
        it('should handle control.basicPurification', async () => {
            ...
            mockAdapterHelper.getChannelNameById.returns('control');
            mockAdapterHelper.getSubChannelNameById.returns('');
            await adapterCommands.handleStateChange(adapter, ctx, 'ecovacs-deebot.0.control.basicPurification', { ack: false, val: true });
        ...
        it('should handle control.resume', async () => {
            ...
            mockAdapterHelper.getChannelNameById.returns('control');
            mockAdapterHelper.getSubChannelNameById.returns('');
            await adapterCommands.handleStateChange(adapter, ctx, 'ecovacs-deebot.0.control.resume', { ack: false, val: true });
            expect(ctx.vacbot.run.calledWith('resume')).to.be.true;
        });
        ...
        it('should handle control.playSound', async () => {
            ...
            mockAdapterHelper.getChannelNameById.returns('control');
            mockAdapterHelper.getSubChannelNameById.returns('');
            await adapterCommands.handleStateChange(adapter, ctx, 'ecovacs-deebot.0.control.playSound', { ack: false, val: true });
        ...
        it('should handle map.loadCurrentMapImage', async () => {
            ...
            mockAdapterHelper.getSubChannelNameById.returns('');
            ctx.currentMapID = '1';
            await adapterCommands.handleStateChange(adapter, ctx, 'ecovacs-deebot.0.map.loadCurrentMapImage', { ack: false, val: true });
        ...
        it('should handle map.loadMapImage', async () => {
            ...
            mockAdapterHelper.getChannelNameById.returns('map');
            mockAdapterHelper.getSubChannelNameById.returns('');
            await adapterCommands.handleStateChange(adapter, ctx, 'ecovacs-deebot.0.map.123.loadMapImage', { ack: false, val: true });
        ...
        it('should handle map.saveVirtualBoundary', async () => {
            ...
            mockAdapterHelper.getChannelNameById.returns('map');
            mockAdapterHelper.getSubChannelNameById.returns('');
            await adapterCommands.handleStateChange(adapter, ctx, 'ecovacs-deebot.0.map.1.virtualBoundaries.5.saveVirtualBoundary', { ack: false, val: true });
        ...
        it('should handle map.deleteVirtualBoundary', async () => {
            ...
            mockAdapterHelper.getChannelNameById.returns('map');
            mockAdapterHelper.getSubChannelNameById.returns('');
            await adapterCommands.handleStateChange(adapter, ctx, 'ecovacs-deebot.0.map.1.virtualBoundaries.5.deleteVirtualBoundary', { ack: false, val: true });
        ...
        it('should handle map.saveVirtualBoundarySet', async () => {
            ...
            mockAdapterHelper.getChannelNameById.returns('map');
            mockAdapterHelper.getSubChannelNameById.returns('');
            await adapterCommands.handleStateChange(adapter, ctx, 'ecovacs-deebot.0.map.1.spotAreas.5.saveVirtualBoundarySet', { ack: false, val: true });
        ...
        it('should handle control.extended.autoBoostSuction', async () => {
            ...
            mockAdapterHelper.getChannelNameById.returns('control');
            mockAdapterHelper.getSubChannelNameById.returns('extended');
            await adapterCommands.handleStateChange(adapter, ctx, 'ecovacs-deebot.0.control.extended.autoBoostSuction', { ack: false, val: true });
        ...
        it('should handle control.extended.cleanPreference', async () => {
            ...
            mockAdapterHelper.getChannelNameById.returns('control');
            mockAdapterHelper.getSubChannelNameById.returns('extended');
            await adapterCommands.handleStateChange(adapter, ctx, 'ecovacs-deebot.0.control.extended.cleanPreference', { ack: false, val: true });
        ...
        it('should handle control.extended.edgeDeepCleaning', async () => {
            ...
            mockAdapterHelper.getChannelNameById.returns('control');
            mockAdapterHelper.getSubChannelNameById.returns('extended');
            await adapterCommands.handleStateChange(adapter, ctx, 'ecovacs-deebot.0.control.extended.edgeDeepCleaning', { ack: false, val: true });
        ...
        it('should handle control.extended.mopOnlyMode', async () => {
            ...
            mockAdapterHelper.getChannelNameById.returns('control');
            mockAdapterHelper.getSubChannelNameById.returns('extended');
            await adapterCommands.handleStateChange(adapter, ctx, 'ecovacs-deebot.0.control.extended.mopOnlyMode', { ack: false, val: true });
        ...
        it('should handle control.extended.airDryingDuration', async () => {
            ...
            mockAdapterHelper.getChannelNameById.returns('control');
            mockAdapterHelper.getSubChannelNameById.returns('extended');
            await adapterCommands.handleStateChange(adapter, ctx, 'ecovacs-deebot.0.control.extended.airDryingDuration', { ack: false, val: 120 });
        ...
        it('should handle control.extended.cleaningMode', async () => {
            ...
            mockAdapterHelper.getChannelNameById.returns('control');
            mockAdapterHelper.getSubChannelNameById.returns('extended');
            await adapterCommands.handleStateChange(adapter, ctx, 'ecovacs-deebot.0.control.extended.cleaningMode', { ack: false, val: 'auto' });
        ...
        it('should handle control.extended.carpetCleaningStrategy', async () => {
            ...
            mockAdapterHelper.getChannelNameById.returns('control');
            mockAdapterHelper.getSubChannelNameById.returns('extended');
            await adapterCommands.handleStateChange(adapter, ctx, 'ecovacs-deebot.0.control.extended.carpetCleaningStrategy', { ack: false, val: 'avoid' });
        ...
        it('should handle control.extended.cleaningClothReminder', async () => {
            ...
            await adapterCommands.handleStateChange(adapter, ctx, 'ecovacs-deebot.0.control.extended.cleaningClothReminder', { ack: false, val: true });
        ...
        it('should handle control.extended.cleaningClothReminder_period', async () => {
            ...
            await adapterCommands.handleStateChange(adapter, ctx, 'ecovacs-deebot.0.control.extended.cleaningClothReminder_period', { ack: false, val: 60 });
        ...
        it('should handle control.extended.voiceAssistant', async () => {
            ...
            mockAdapterHelper.getChannelNameById.returns('control');
            mockAdapterHelper.getSubChannelNameById.returns('extended');
            await adapterCommands.handleStateChange(adapter, ctx, 'ecovacs-deebot.0.control.extended.voiceAssistant', { ack: false, val: true });
        ...
        it('should handle control.extended.bluetoothSpeaker', async () => {
            ...
            mockAdapterHelper.getChannelNameById.returns('control');
            mockAdapterHelper.getSubChannelNameById.returns('extended');
            await adapterCommands.handleStateChange(adapter, ctx, 'ecovacs-deebot.0.control.extended.bluetoothSpeaker', { ack: false, val: true });
        ...
        it('should handle control.extended.microphone', async () => {
            ...
            mockAdapterHelper.getChannelNameById.returns('control');
            mockAdapterHelper.getSubChannelNameById.returns('extended');
            await adapterCommands.handleStateChange(adapter, ctx, 'ecovacs-deebot.0.control.extended.microphone', { ack: false, val: true });
        ...
        it('should handle control.extended.voiceReport', async () => {
            ...
            mockAdapterHelper.getChannelNameById.returns('control');
            mockAdapterHelper.getSubChannelNameById.returns('extended');
            await adapterCommands.handleStateChange(adapter, ctx, 'ecovacs-deebot.0.control.extended.voiceReport', { ack: false, val: true });
        ...
        it('should handle control.extended.atmoVolume', async () => {
            ...
            mockAdapterHelper.getChannelNameById.returns('control');
            mockAdapterHelper.getSubChannelNameById.returns('extended');
            await adapterCommands.handleStateChange(adapter, ctx, 'ecovacs-deebot.0.control.extended.atmoVolume', { ack: false, val: 8 });
        ...
        it('should handle control.extended.atmoLight', async () => {
            ...
            mockAdapterHelper.getChannelNameById.returns('control');
            mockAdapterHelper.getSubChannelNameById.returns('extended');
            await adapterCommands.handleStateChange(adapter, ctx, 'ecovacs-deebot.0.control.extended.atmoLight', { ack: false, val: 2 });
        ...
        it('should handle control.spotArea buttons', async () => {
            ...
            mockAdapterHelper.getSubChannelNameById.returns('');
            ctx.getDevice().useV2commands.returns(false);
            await adapterCommands.handleStateChange(adapter, ctx, 'ecovacs-deebot.0.control.spotArea_1', { ack: false, val: true });
        ...
        it('should not process when not connected', async () => {
            ...
            mockAdapterHelper.getChannelNameById.returns('control');
            mockAdapterHelper.getSubChannelNameById.returns('');
            await adapterCommands.handleStateChange(adapter, ctx, 'ecovacs-deebot.0.control.clean', { ack: false, val: true });
        ...
        it('should handle history channel without processing commands', async () => {
            ...
            mockAdapterHelper.getChannelNameById.returns('history');
            mockAdapterHelper.getSubChannelNameById.returns('');
            await adapterCommands.handleStateChange(adapter, ctx, 'ecovacs-deebot.0.history.someHistory', { ack: false, val: true });
        });
        ...
        it('should handle control.customArea_cleanings', async () => {
            ...
            mockAdapterHelper.getChannelNameById.returns('control');
            mockAdapterHelper.getSubChannelNameById.returns('');
            await adapterCommands.handleStateChange(adapter, ctx, 'ecovacs-deebot.0.control.customArea_cleanings', { ack: false, val: 3 });
        ...
        it('should handle control.spotArea_cleanings', async () => {
            ...
            mockAdapterHelper.getChannelNameById.returns('control');
            mockAdapterHelper.getSubChannelNameById.returns('');
            await adapterCommands.handleStateChange(adapter, ctx, 'ecovacs-deebot.0.control.spotArea_cleanings', { ack: false, val: 3 });
        ...
        it('should handle extended.pauseBeforeDockingChargingStation', async () => {
            ...
            mockAdapterHelper.getChannelNameById.returns('control');
            mockAdapterHelper.getSubChannelNameById.returns('extended');
            await adapterCommands.handleStateChange(adapter, ctx, 'ecovacs-deebot.0.control.extended.pauseBeforeDockingChargingStation', { ack: false, val: true });
        ...
        it('should handle extended.pauseBeforeDockingIfWaterboxInstalled', async () => {
            ...
            mockAdapterHelper.getChannelNameById.returns('control');
            mockAdapterHelper.getSubChannelNameById.returns('extended');
            await adapterCommands.handleStateChange(adapter, ctx, 'ecovacs-deebot.0.control.extended.pauseBeforeDockingIfWaterboxInstalled', { ack: false, val: true });
        ...
        it('should handle extended.resetCleanSpeedToStandardOnReturn', async () => {
            ...
            mockAdapterHelper.getChannelNameById.returns('control');
            mockAdapterHelper.getSubChannelNameById.returns('extended');
            await adapterCommands.handleStateChange(adapter, ctx, 'ecovacs-deebot.0.control.extended.resetCleanSpeedToStandardOnReturn', { ack: false, val: true });
        ...
        it('should handle extended.pauseWhenLeavingSpotArea', async () => {
            ...
            mockAdapterHelper.getChannelNameById.returns('control');
            mockAdapterHelper.getSubChannelNameById.returns('extended');
            await adapterCommands.handleStateChange(adapter, ctx, 'ecovacs-deebot.0.control.extended.pauseWhenLeavingSpotArea', { ack: false, val: '3' });
        ...
        it('should handle map.savedBoundarySets', async () => {
            ...
            await adapterCommands.handleStateChange(adapter, ctx, 'ecovacs-deebot.0.map.savedBoundarySets.virtualBoundarySet_123', { ack: false, val: true });
        ...
        it('should handle map.savedBoundaries', async () => {
            ...
            await adapterCommands.handleStateChange(adapter, ctx, 'ecovacs-deebot.0.map.savedBoundaries.virtualBoundary_123', { ack: false, val: true });
        ...
        it('should handle control.waterLevel_reset', async () => {
            ...
            await adapterCommands.handleStateChange(adapter, ctx, 'ecovacs-deebot.0.control.waterLevel_reset', { ack: false, val: true });
        ...
        it('should handle control.cleanSpeed_reset', async () => {
            ...
            await adapterCommands.handleStateChange(adapter, ctx, 'ecovacs-deebot.0.control.cleanSpeed_reset', { ack: false, val: true });
            expect(ctx.adapterProxy.setStateConditional.called).to.be.true;
        });
        ...
        it('should handle map.deebotPosition savedGoToPositionValues', async () => {
            ...
            ctx.getModel().isModelTypeAirbot.returns(false);
            await adapterCommands.handleStateChange(adapter, ctx, 'ecovacs-deebot.0.control.extended.savedGoToPositionValues.goToPosition_123', { ack: false, val: true });
            expect(ctx.vacbot.run.called).to.be.true;
        });
        ...
        it('should handle consumable side_brush_reset', async () => {
            ...
            mockAdapterHelper.getChannelNameById.returns('consumable');
            mockAdapterHelper.getSubChannelNameById.returns('');
            await adapterCommands.handleStateChange(adapter, ctx, 'ecovacs-deebot.0.consumable.side_brush_reset', { ack: false, val: true });
        ...
        it('should handle consumable unit_care_reset', async () => {
            ...
            mockAdapterHelper.getChannelNameById.returns('consumable');
            mockAdapterHelper.getSubChannelNameById.returns('');
            await adapterCommands.handleStateChange(adapter, ctx, 'ecovacs-deebot.0.consumable.unit_care_reset', { ack: false, val: true });
        ...
        it('should handle consumable round_mop_reset', async () => {
            ...
            mockAdapterHelper.getChannelNameById.returns('consumable');
            mockAdapterHelper.getSubChannelNameById.returns('');
            await adapterCommands.handleStateChange(adapter, ctx, 'ecovacs-deebot.0.consumable.round_mop_reset', { ack: false, val: true });
        ...
        it('should handle consumable airFreshener_reset', async () => {
            ...
            mockAdapterHelper.getChannelNameById.returns('consumable');
            mockAdapterHelper.getSubChannelNameById.returns('');
            await adapterCommands.handleStateChange(adapter, ctx, 'ecovacs-deebot.0.consumable.airFreshener_reset', { ack: false, val: true });
        ...
        it('should handle control.mobilePurification', async () => {
            ...
            mockAdapterHelper.getChannelNameById.returns('control');
            mockAdapterHelper.getSubChannelNameById.returns('');
            await adapterCommands.handleStateChange(adapter, ctx, 'ecovacs-deebot.0.control.mobilePurification', { ack: false, val: true });
