        ...
        for (const spotAreaID in spotAreaArray) {
            if (Object.prototype.hasOwnProperty.call(spotAreaArray, spotAreaID)) {
                ...
                adapter.getObject(spotAreaChannel, function (err, spotAreaObj) {
                    if (!spotAreaObj) {
                        createSpotAreaData(adapter, mapID, spotAreaID);
                    } else {
                        updateSpotAreaData(adapter, spotAreaChannel, spotAreaArray[spotAreaID]);
                    }
                });
            }
        }
...
function processSpotAreaInfo(adapter, spotArea) {
    ...
    adapter.getObject(mapChannel + '.spotAreas.' + spotAreaID, function (err, spotAreaObj) {
        ...
        if (spotAreaObj) {
            updateSpotAreaData(adapter, mapChannel + '.spotAreas.' + spotAreaID, spotArea);
...
function createSpotAreaData(adapter, mapID, spotAreaID) {
...
function updateSpotAreaData(adapter, spotAreaChannel, spotAreaArray) {
            ...
            if (Object.prototype.hasOwnProperty.call(virtualBoundaryArray, extVirtualBoundaryId)) {
                ...
                adapter.getObject(virtualBoundaryChannel, function (err, virtualBoundaryObj) {
                    if (virtualBoundaryObj) {
                        ...
                        createVirtualBoundaryData(adapter, virtualBoundaryChannel, virtualBoundaryArray[extVirtualBoundaryId]['mapVirtualBoundaryID'], virtualBoundaryArray[extVirtualBoundaryId]['mapVirtualBoundaryType']);
                    }
                });
            }
        }
...
function processVirtualBoundaryInfo(adapter, virtualBoundary) {
    ...
    adapter.getObject(virtualBoundaryChannel, function (err, virtualBoundaryObj) {
        ...
        if (virtualBoundaryObj) {
            ...
            createVirtualBoundaryData(adapter, mapChannel, virtualBoundary['mapVirtualBoundaryID'], virtualBoundary['mapVirtualBoundaryType']);
        }
    });
}
...
function createVirtualBoundaryData(adapter, virtualBoundaryChannel, mapVirtualBoundaryID, mapVirtualBoundaryType) {
