...
async function createSpotAreaObjectsNotExists(adapter, mapID, spotAreaID) {
    ...
    await adapter.createObjectNotExists(
        ...
        'string', 'text', false, '');
    if (adapter.getModel().isSupportedFeature('control.cleanSpeed')) {
...
async function createVirtualBoundaryObjectsNotExists(adapter, virtualBoundaryChannel, mapVirtualBoundaryID, mapVirtualBoundaryType) {
    ...
    await adapter.createObjectNotExists(
        ...
        'text', false, '');
    await createVirtualBoundaryButtonsNotExists(adapter, virtualBoundaryChannel, mapVirtualBoundaryID);
}

async function createVirtualBoundaryButtonsNotExists(adapter, virtualBoundaryChannel, mapVirtualBoundaryID) {
