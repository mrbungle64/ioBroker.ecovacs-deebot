...
class Device {
    ...
    setStatus(status) {
        this.status = status;
        this.adapter.log.silly(`[setStatus] status = '${this.status}' (cleanStatus = '${this.cleanStatus}', chargeStatus = '${this.chargeStatus}')`);
    }
    ...
    setStatusByTrigger(trigger) {
        this.adapter.log.silly(`[setStatus] trigger = '${trigger}'`);
        ...
        } else if ((this.cleanStatus === 'idle') && (this.chargeStatus === null)) {
            this.setStatus(helper.getDeviceStatusByStatus('charging'));
        } else {
            this.setStatus(helper.getDeviceStatusByStatus(this.cleanStatus));
        }
