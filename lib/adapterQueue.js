...
class Queue {
    ...
    addInitialGetCommands() {
        ...
        if (this.adapter.getModelType() === 'aqMonitor') {
            this.add('GetJCYAirQuality');
            return;
        }
        if (this.adapter.getModel().isModelTypeAirbot()) {
        ...
        if (this.adapter.getModel().hasAirDrying()) {
            if (this.adapter.getModelType() === 'yeedi') {
    ...
    addStandardGetCommands() {
        ...
        if (this.adapter.getModel().hasAdvancedMode()) {
    ...
    addGetLifespan() {
        const modelType = this.adapter.getModelType();
        if (modelType === 'airbot') {
