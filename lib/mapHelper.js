    ...
    adapter.getChannelsOf('map.' + mapID + '.virtualBoundaries', function (err, channel) { //check existing virtualBoundary states
        ...
        for (const r in channel) {
            ...
            if (!virtualBoundary) {
                ...
                deleteVirtualBoundaryData(adapter, virtualBoundaryObj._id);
            } else {
                updateVirtualBoundaryData(adapter, virtualBoundaryObj._id, virtualBoundary);
            }
...
function deleteVirtualBoundaryData(adapter, virtualBoundaryChannel) {
...
function updateVirtualBoundaryData(adapter, virtualBoundaryChannel, virtualBoundary) {
