        ...
        for (const extSpotAreaId in spotAreaArray) { //create new states
            adapter.getObject('map.' + mapID + '.' + extSpotAreaId, function (err, spotAreaObj) {
                if (spotAreaObj) {
                    ...
                    adapter.createObjectNotExists('map.' + mapID + '.spotAreas.' + extSpotAreaId + '.spotAreaBoundaries', 'Boundaries of the SpotArea', 'string', 'text', false, '', '');
...
function processSpotAreaInfo(adapter, spotArea) {
    ...
    adapter.getObject('map.' + mapID + '.spotAreas.' + spotAreaID, function (err, spotAreaObj) {
        if (err) {
        ...
        if (spotAreaObj) {
            ...
            adapter.setStateChanged('map.' + mapID + '.spotAreas.' + spotAreaID + '.spotAreaIsAvailable', true, true);
            adapter.setStateChanged('map.' + mapID + '.spotAreas.' + spotAreaID + '.spotAreaDeactivationTimestamp', null, true);
            adapter.setStateChanged('map.' + mapID + '.spotAreas.' + spotAreaID + '.spotAreaBoundaries', spotArea['mapSpotAreaBoundaries'], true);
            let id = 'map.' + mapID + '.spotAreas.' + spotAreaID + '.spotAreaName';
            adapter.getObject(id, function (err, obj) {
                if (!obj) {
                    ...
                    adapter.createObjectNotExists('map.' + mapID + '.spotAreas.' + spotAreaID + '.spotAreaName', 'Name of the SpotArea', 'string', 'text', false, mapSpotAreaName, '');
                } else {
            ...
            adapter.createChannelNotExists('map.' + mapID, 'Map ' + mapID);
            adapter.createChannelNotExists('map.' + mapID + '.spotAreas', 'SpotAreas');
            adapter.createChannelNotExists('map.' + mapID + '.spotAreas.' + spotAreaID, 'SpotArea ' + spotAreaID);
            adapter.createObjectNotExists('map.' + mapID + '.spotAreas.' + spotAreaID + '.spotAreaID', 'ID of the SpotArea', 'string', 'text', false, spotAreaID, '');
            adapter.createObjectNotExists('map.' + mapID + '.spotAreas.' + spotAreaID + '.spotAreaIsAvailable', 'Is the SpotArea still available?', 'boolean', 'indicator.status', false, true, '');
            adapter.createObjectNotExists('map.' + mapID + '.spotAreas.' + spotAreaID + '.spotAreaDeactivationTimestamp', 'When was the SpotArea deactivated (null if active)', 'number', 'value.datetime', false, null, '');
            adapter.createObjectNotExists('map.' + mapID + '.spotAreas.' + spotAreaID + '.spotAreaName', 'Name of the SpotArea', 'string', 'text', false, mapSpotAreaName, '');
            adapter.createObjectNotExists('map.' + mapID + '.spotAreas.' + spotAreaID + '.spotAreaBoundaries', 'Boundaries of the SpotArea', 'string', 'text', false, spotArea['mapSpotAreaBoundaries'], '');
        }
