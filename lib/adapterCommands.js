...
function goToPosition(adapter, state) {
    ...
    if (helper.positionValueStringIsValid(goToPositionValues)) {
        if (Number(adapter.getDevice().useNativeGoToPosition()) === 1) {
            adapter.log.info('Go to position (native T8): ' + goToPositionValues);
        ...
        } else if (Number(adapter.getDevice().useNativeGoToPosition()) === 2) {
            adapter.log.info('Go to position (native T9): ' + goToPositionValues);
